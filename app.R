...
if (!devel) {
  ...
  # Sys.setenv('plotly_username'="nplatonov")
  # Sys.setenv('plotly_api_key'="AEunAoq3Vnin1QXFJOtO")
} 
epsgList <- 3571:3576
               ...
               ,HTML(
                 '<link href="https://fonts.googleapis.com/css?family=Roboto" rel="stylesheet"/>
                  ...
                  <style>
                     ...
                     @media screen {
                     .skin-blue #viewerLeaflet, .skin-blue #viewerMapview, .skin-blue #editor-map {
                     ...
                     ,fluidRow(NULL
                        ...
                        ,column(3
                           ...
                           ,sliderInput("litter", "Litter size"
                                       ,width=sliderWidth
                                       ,min=1.2, max=2.2,value=init$litter,step=0.01
                                       )
                           ,fluidRow(NULL
