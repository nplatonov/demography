            ...
            ,fluidRow(NULL
               ,tabBox(width=12,title = "",id = "tabset1", selected="Inputs"
                  ,tabPanel("Input",value="Inputs"#,icon=icon("align-left")
                     ...
                     ,fluidRow(NULL
                        ,column(3,
                           sliderInput("mortality.cub", "COY mortality",
                    ...
                    # ,"Parameters of demography tube:"
                     ,fluidRow(NULL
                        ,column(3,
                           sliderInput("k1d", "Mortality rate of dependent younf",
                                       min=1, max=20, value=init$k1d,step=0.001
                                      )
                        )
                        ,column(3,
                           sliderInput("k1i", "Mortality rate of independent youngs",
                                       min=1, max=20, value=init$k1i,step=0.001
                                      )
                        )
                        ,column(3,
                           sliderInput("k2", "Mortality rate of aging",
                                       min=1, max=20, value=init$k2,step=0.001
                                      )
                        )
                        ,column(3,
